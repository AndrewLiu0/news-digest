...
from nodes.process import (
    ...
    save_pre_filtered_sources,
    filter_relevance, 
    save_raw_sources, 
    strategic_deduplication
)
from nodes.publish import publish_source_list
...
builder.add_node("save_pre_filtered_sources", save_pre_filtered_sources)
...
# 4. REPORTING PHASE
builder.add_node("publish_source_list",    publish_source_list)
...
# Feed all results into pre-processor
...
# Linear Sequence
builder.add_edge("deduplicate_and_filter", "save_pre_filtered_sources")
builder.add_edge("save_pre_filtered_sources", "filter_relevance")
builder.add_edge("filter_relevance",       "save_raw_sources")
builder.add_edge("save_raw_sources",        "strategic_deduplication")
builder.add_edge("strategic_deduplication", "publish_source_list")
builder.add_edge("publish_source_list",    END)
